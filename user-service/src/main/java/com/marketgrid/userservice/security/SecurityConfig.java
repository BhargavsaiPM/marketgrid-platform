package com.marketgrid.userservice.security;
 ...
 *   <li>Sessions are stateless — every request must carry its own JWT.</li>
 * </ul>
 */
@Configuration
@EnableWebSecurity
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .headers(headers -> headers
                        .frameOptions(frame -> frame.disable())) // allow H2 console iframes
